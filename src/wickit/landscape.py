...
Purpose: Detect and categorize platforms/websites for targeted behavior.

Features:
- Platform detection by URL patterns
- Platform categorization (LMS, job boards, etc.)
- Platform metadata (name, category, features)
- Custom platform registration

Usage:
    from omni_kit.platforms import detect_platform, get_platform_info, PLATFORMS

    platform = detect_platform("https://canvas.edu/courses/123")
    if platform:
        print(f"Detected: {platform.name} ({platform.category})")
"""
