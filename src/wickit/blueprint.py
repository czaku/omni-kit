...
Purpose: Validate JSON data against schemas with clear error messages.
...
Usage:
    from omni_kit.schemify import validate, SchemaError, validate_required_fields

    try:
        data = validate(json_data, schema)
