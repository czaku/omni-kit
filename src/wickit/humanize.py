"""Mistake injection for human-like behavior simulation.

Purpose: Simulate human-like mistakes and behavior patterns for testing and AI simulation.

Features:
- Configurable mistake levels (none, slight, moderate, grand, major)
- Random mistake injection based on probability
- Realistic mistake types (typos, omissions, hesitations)
- Warning messages for different mistake levels

Usage:
    from omni_kit.mistaker import Mistaker, should_make_mistake, get_mistake_info

    mistaker = Mistaker(level="slight")
    if mistaker.should_mistake():
        result = mistaker.inject_mistake(text)
"""
