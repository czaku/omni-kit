...
Purpose: Manage learning with optimal review intervals based on performance.

The SM-2 algorithm calculates when a card should next be reviewed based on:
- How well you remembered it (quality rating 0-5)
- Previous interval and ease factor
- Number of successful repetitions

Usage:
    from omni_kit.spaced_repetition import SM2Card, calculate_interval, ease_factor_for_quality

    card = SM2Card(front="Question", back="Answer")
    new_interval, new_ef = calculate_interval(card, quality=5)
"""
